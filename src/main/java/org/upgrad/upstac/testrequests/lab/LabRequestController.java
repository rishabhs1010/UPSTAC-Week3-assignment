...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester() {
        try {
            ...
            //return test results assign to the logged-in tester
            return testRequestQueryService.findByTester(user);

        } catch (Error err) {
            //throw error if something went wrong
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Error in finding assigned test for logged in user");
        }
    }
